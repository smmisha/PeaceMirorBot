...
async def generate_ai_reply(user_prompt: str, user_name: str = "Участник") -> str:
    ...
    system_prompt = (
        ...
        "3. 🛑 МИНИМУМ ЭМОДЗИ (СТРОГО!): Используй МАКСИМУМ 1 эмодзи на ВСЁ сообщение в самом конце (или вообще пиши БЕЗ эмодзи)! Категорически ЗАПРЕЩЕНО ставить по 5–8 эмодзи в каждое предложение!\n"
