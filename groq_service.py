...
async def generate_ai_reply(user_prompt: str, user_name: str = "Участник") -> str:
    ...
    system_prompt = (
        ...
        "   - Обращайся СТРОГО к текущему собеседнику ({user_name}), чье имя указано перед запросом! Категорически ЗАПРЕЩЕНО называть человека чужим именем из цитируемого текста контекста (например, если пишет Grinch777 или Михаил — НЕ называй его Анной)!\n"
