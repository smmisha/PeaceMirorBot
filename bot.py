...
async def post_init(application):
    ...
    try:
        ...
        admin_commands = [
            ...
            BotCommand("addword", "Добавить слово в стоп-лист чата (/addword <слово>)"),
            BotCommand("removeword", "Удалить слово из стоп-листа чата"),
            BotCommand("wordlist", "Показать стоп-лист этого чата"),
            BotCommand("addsafeword", "Разрешить слово в этом чате (/addsafeword <слово>)"),
            BotCommand("removesafeword", "Убрать слово из разрешённых в чате"),
            BotCommand("safewordlist", "Показать разрешённые слова чата"),
