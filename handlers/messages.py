...
THANKS_WEAK_REGEX = re.compile(
    r'(?:^|\W)(?:красавчик|красава|красотка|красавица|молодец|молодчина|обнял|обняла|'
    r'принял|принято|умница|умничка|гений|легенда|огонь|зачёт|зачет|чётко|четко|'
    r'шикарно|гениально|браво)(?:\W|$)',
    re.IGNORECASE
)
